...
const SearchEngine = ({ scapeState, setScapeState }: Props) => {
  const value = scapeState.enableSearchEngine;
  ...
  const handleAddKeyword = () => {
    ...
    setScapeState({
      ...scapeState,
      keywords: [...scapeState.keywords, inputValue],
    });
  ...
  const handleRemoveKeyword = (keyword: string) => {
    setScapeState({
      ...scapeState,
      keywords: scapeState.keywords.filter((k) => k !== keyword),
    });
  };
  ...
  const handleToggleEnabled = () => {
    setScapeState({
      ...scapeState,
      enableSearchEngine: !scapeState.enableSearchEngine,
    });
  };
        ...
        {value && (
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {scapeState.keywords.map((keyword: any) => (
                <div
                  key={keyword}
